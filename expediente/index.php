...
//    $soapstruct = new SoapVar($params, SOAP_ENC_OBJECT, "params", "http://webservices.mppeuct.gob.ve/personal/schema.xsd");
            ...
            $client = new SoapClient("http://172.17.90.49/webservices/proveedor/proveedor.wsdl", array());
            $soapstruct = new SoapVar($params, SOAP_ENC_OBJECT, "params", "http://172.17.90.49/webservices/proveedor/schema.xsd");
