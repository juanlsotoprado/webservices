...
class Servicios extends Conexion{
	...
	function enviarSolicitudConfirmacion(){
		return 1;
		$mensaje= 		$parametros->mensaje;
		$destinatario= 	$parametros->destinatario;
		if($mensaje!='' && $destinatario!=''){//validación de parametros no vacío
				
			try{
				$respuesta=Functiones::enviarSolicitudConfirmacion($mensaje, $destinatario);
			}
			catch(Exception $e){
