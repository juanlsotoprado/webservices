...
try {
	$id=2;//esta es el identificador para este correo en especifico, si se desea otro agregar otro contador a la BD y utilizarlo
	$params = array('limite'=>'40', 'desde'=>'2016-08-01', 'id'=>$id);
	$clientOptions = array();
	...
	$objeto = $client->solicitarActualizacion2(new SoapParam($soapstruct, "message"));
	var_dump($objeto);die();
