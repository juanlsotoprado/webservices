...
try {
    ...
    $params = array('limite' => '25');
    $clientOptions = array();
    $wsdl = "http://172.17.90.49/webservices/global/global.wsdl";
    $client = new SoapClient($wsdl, $clientOptions);
    $soapstruct = new SoapVar($params, SOAP_ENC_OBJECT, "params", "http://172.17.90.49/webservices/global/schema.xsd");
    $objeto = $client->mensajesMasivosSms(new SoapParam($soapstruct, "message"));
    echo "<pre>";
