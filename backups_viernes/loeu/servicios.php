...
class Servicios extends MySQL{
	...
	function getUniversidades($parametros){//servicio para el uso de la mensajeria de texto, recibe como parametros la cedula y la nacionalidad
	...
	function getCarrerasUniversidad($parametros){//servicio para el uso de la mensajeria de texto, recibe como parametros la cedula y la nacionalidad
		$filtros = $parametros->filtros;
		$output = array(
				"error" => 0,
				"respuesta" => array()
	...
	function getDetalleUniversidadPorId($parametros){//servicio para el uso de la mensajeria de texto, recibe como parametros la cedula y la nacionalidad
		$filtros = $parametros->filtros;
		$output = array(
				"error" => 0,
				"respuesta" => array()
	...
	function getDetalleCarreraPorId($parametros){//servicio para el uso de la mensajeria de texto, recibe como parametros la cedula y la nacionalidad
		$filtros = $parametros->filtros;
		$output = array(
				"error" => 0,
				"respuesta" => array()
